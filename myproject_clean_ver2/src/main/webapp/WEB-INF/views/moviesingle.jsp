			...
			<div class="row ipad-width2">
				...
				<div class="col-md-8 col-sm-12 col-xs-12">
					<div class="movie-single-ct main-content">
						<h1 class="bd-hd">
							${requestScope.movie.title } <span>${requestScope.movie.repRlsDate }</span>
						</h1>
							...
							<div class="tabs">
								...
								<div class="tab-content">
									<div id="overview" class="tab active">
										<div class="row">
											<div class="col-md-8 col-sm-12 col-xs-12">
												<p>${requestScope.movie.plotText }</p>
											...
											<div class="col-md-4 col-xs-12 col-sm-12">
												<div class="sb-it">
													<h6>Director:</h6>
													<p>
														${requestScope.movie.directorNm }
														${requestScope.movie.directorEnNm }
													</p>
												</div>
												<div class="sb-it">
													<h6>Writer:</h6>
												...
												<div class="sb-it">
													<h6>Stars:</h6>
													<p>
														${requestScope.movie.actorNm }<br>
														${requestScope.movie.actorEnNm }
													</p>
												</div>
												<div class="sb-it">
													<h6>Genres:</h6>
													<p>
														${requestScope.movie.genre }
													</p>
												</div>
												<div class="sb-it">
													<h6>Release Date:</h6>
												...
												<div class="sb-it">
													<h6>Run Time:</h6>
													<p>${requestScope.movie.runtime }</p>
												</div>
												<div class="sb-it">
													<h6>Rating:</h6>
													<p>${requestScope.movie.rating }</p>
												</div>
												<div class="sb-it">
													<h6>Plot Keywords:</h6>
													<p class="tags">
														<span class="time"><a href="#">${requestScope.movie.keywords }</a></span>
													</p>
												</div>
												<div class="ads">
										...
										<div class="row">
											...
											<div class="mvsingle-item media-item">
												...
												<div class="vd-item">
													...
													<div class="vd-infor">
														<h6>
															<a href="#">Featurette: âAvengers Re-Assembled</a>
														</h6>
														<p class="time">1: 03</p>
													</div>
												</div>
									...
									<div id="moviesrelated" class="tab">
										<div class="row">
											...
											<div class="topbar-filter">
												...
												<label>Sort by:</label><select><option
														value="popularity">Popularity Descending</option>
													<option value="popularity">Popularity Ascending</option>
													<option value="rating">Rating Descending</option>
													<option value="rating">Rating Ascending</option>
											...
											<div class="movie-item-style-2">
												...
												<div class="mv-item-infor">
													...
													<p class="describe">Earth's mightiest heroes must come
														...
														humanity...</p>
													<p class="run-time">
														Run Time: 2h21â . <span>MMPA: PG-13 </span> . <span>Release:
															1 May 2015</span>
													</p>
													<p>
											...
											<div class="topbar-filter">
												...
												<div class="pagination2">
													<span>Page 1 of 2:</span><a class="active" href="#">1</a><a
														href="#">2</a><a href="#"><i class="ion-arrow-right-b"></i></a>
												</div>
											</div>
										</div>
									</div>
