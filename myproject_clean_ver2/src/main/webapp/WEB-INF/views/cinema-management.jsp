...
<script type="text/javascript">
	...
	$(document).on('click', '#window', function() {
  	  	$("#form").attr('action','MyMovieList-management.do');
  	  	window.open('MyMovieList-management.do','POP',"width=1200, height=800, resizable=no, scrollbars=no, status=no;"); 
  	  	$("#form").submit();
  	  $(".t1").remove();
  	});
  	});
...
<link rel="stylesheet" type="text/css"
	href="../resources/css/evo-calendar.css" />
<link rel="stylesheet" type="text/css"
	href="../resources/css/evo-calendar.midnight-blue.css" />
<script
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link" href="index.do">
					<i class="fas fa-fw fa-tachometer-alt"></i> <span>${sessionScope.cinemacode }</span>
			</a></li>
			...
			<div class="sidebar-heading">
				<span>${sessionScope.cinemacode }</span>
			</div>
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">목록	</h6>
                     	<a class="collapse-item" href="MyMovieList.do">등록된 영화 목록</a>
                           <a class="collapse-item" href="openAPI.do">오픈 api 영화 검색</a>
                        <a class="collapse-item" href="insertMovie.do">영화 등록 하기</a>
                    </div>
                </div>
            </li>
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Utilities:</h6>
                         <a id="modal-open" class="collapse-item" href="#">지점 선택</a>
                    </div>
                </div>
                </c:if>
                <c:if test="${sessionScope.cinemacode != null }">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">${sessionScope.name }점</h1>
						<a href="#"
					...
					<!-- Content Row -->
					<c:forEach var="dto" items="${requestScope.Screenlist }">
						<a href="index-cinema.do?name=${dto.screencode }"> ${dto.screenname }</a>
					</c:forEach>
					<button id="window">추가</button>
					...
					<!-- End of Footer -->
				<div class="container-fluid">
                <jsp:include page="template/select_cinema_branch.jsp" flush="false"></jsp:include>  
                </div>
				</div>
